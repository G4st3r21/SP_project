...
class IndicationsRFVO:
    def __init__(self, cur, conn):
        self.table_name = "indications_rf_vo"
        self.schema = "public"
    ...
    def get_id_by_name(self, title):
        self.cur.execute(f"SELECT * FROM {self.schema}.{self.table_name} * WHERE id_ind_vo like '{title}'")
