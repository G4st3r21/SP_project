...
ControlEvent2020 = SPTableArbitrary('control_event2021', cur, conn, schema='Employment_Promotion')
CommentsCE2020 = SPTableArbitrary('comments_ce2021',  cur, conn, schema='Employment_Promotion')
DateControlEvent2020 = SPTableArbitrary('date_control_event2021', cur, conn, schema='Employment_Promotion')
table_parsing()
