...
ControlEvent2020 = SPTableArbitrary('control_event2020', cur, conn, schema='Employment_Promotion')
CommentsCE2020 = SPTableArbitrary('comments_ce2020',  cur, conn, schema='Employment_Promotion')
DateControlEvent2020 = SPTableArbitrary('date_control_event2020', cur, conn, schema='Employment_Promotion')
table_parsing()