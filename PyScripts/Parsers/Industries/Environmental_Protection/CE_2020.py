...
ControlEvent2020 = SPTableArbitrary('control_event2020', cur, conn, schema='Environmental_Protection')
CommentsCE2020 = SPTableArbitrary('comments_ce2020',  cur, conn, schema='Environmental_Protection')
DateControlEvent2020 = SPTableArbitrary('date_control_event2020', cur, conn, schema='Environmental_Protection')
table_parsing()