...
cols, rows, cur, conn = parser_init('_11.1. Контрольные события 2021.xlsx', sheet_number=1, first_str_number=12)
ResponseObj = SPTable('response_obj', cur, conn)
ControlEvent2020 = SPTableArbitrary('control_event2021', cur, conn, schema='Environmental_Protection')
CommentsCE2020 = SPTableArbitrary('comments_ce2021',  cur, conn, schema='Environmental_Protection')
DateControlEvent2020 = SPTableArbitrary('date_control_event2021', cur, conn, schema='Environmental_Protection')
table_parsing()
