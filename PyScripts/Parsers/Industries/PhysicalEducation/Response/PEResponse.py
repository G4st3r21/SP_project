...
Subprogram = SPTableArbitrary('subprogram' + year, cur, conn, schema='Physical_Education')
MainEvent = SPTableArbitrary('main_event' + year, cur, conn, schema='Physical_Education')
AllEvents = SPTableManyToMany('all_events' + year, cur, conn, schema='Physical_Education')
ResponseObj = SPTable('response_obj', cur, conn)
ResponseFio = SPTableArbitrary('response_fio' + year, cur, conn, schema='Physical_Education')
EventsResponseObj = SPTableManyToMany('events_response_obj' + year, cur, conn, schema='Physical_Education')
EventsResponseFio = SPTableManyToMany('events_response_fio' + year, cur, conn, schema='Physical_Education')
# ResponseMain = SPTableArbitrary('response_main' + year, cur, conn, schema='Physical_Education')
