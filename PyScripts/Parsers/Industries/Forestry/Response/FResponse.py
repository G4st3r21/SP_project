...
MainEvent = SPTableArbitrary('main_event' + year, cur, conn, schema='Forestry')
Event = SPTableArbitrary('event' + year, cur, conn, schema='Forestry')
AllEvents = SPTableManyToMany('all_events' + year, cur, conn, schema='Forestry')
ResponseObj = SPTable('response_obj', cur, conn)
ResponseFio = SPTableArbitrary('response_fio' + year, cur, conn, schema='Forestry')
EventsResponseObj = SPTableManyToMany('events_response_obj' + year, cur, conn, schema='Forestry')
EventsResponseFio = SPTableManyToMany('events_response_fio' + year, cur, conn, schema='Forestry')
