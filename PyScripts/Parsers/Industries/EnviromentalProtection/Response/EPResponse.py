...
MainEvent = SPTableArbitrary('main_event' + year, cur, conn, schema='Environmental_Protection')
Event = SPTableArbitrary('event' + year, cur, conn, schema='Environmental_Protection')
AllEvents = SPTableManyToMany('all_events' + year, cur, conn, schema='Environmental_Protection')
ResponseObj = SPTable('response_obj', cur, conn)
ResponseFio = SPTableArbitrary('response_fio' + year, cur, conn, schema='Environmental_Protection')
EventsResponseObj = SPTableManyToMany('events_response_obj' + year, cur, conn, schema='Environmental_Protection')
EventsResponseFio = SPTableManyToMany('events_response_fio' + year, cur, conn, schema='Environmental_Protection')
