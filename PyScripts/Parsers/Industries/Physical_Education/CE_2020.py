...
ControlEvent2020 = SPTableArbitrary('control_event2020', cur, conn, schema='Physical_Education')
CommentsCE2020 = SPTableArbitrary('comments_ce2020',  cur, conn, schema='Physical_Education')
DateControlEvent2020 = SPTableArbitrary('date_control_event2020', cur, conn, schema='Physical_Education')
table_parsing()