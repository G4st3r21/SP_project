...
cols, rows, cur, conn = parser_init('ГОДОВОЙ ОТЧЕТ.xlsx', sheet_number=4, first_str_number=12)
ResponseObj = SPTable('response_obj', cur, conn)
ControlEvent2020 = SPTableArbitrary('control_event2021', cur, conn, schema='Physical_Education')
CommentsCE2020 = SPTableArbitrary('comments_ce2021',  cur, conn, schema='Physical_Education')
DateControlEvent2020 = SPTableArbitrary('date_control_event2021', cur, conn, schema='Physical_Education')
table_parsing()
