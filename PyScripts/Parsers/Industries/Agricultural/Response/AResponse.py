...
Subprogram = SPTableArbitrary('subprogram' + year, cur, conn, schema='Agricultural')
MainEvent = SPTableArbitrary('main_event' + year, cur, conn, schema='Agricultural')
Event = SPTableArbitrary('event' + year, cur, conn, schema='Agricultural')
AllEvents = SPTableManyToMany('all_events' + year, cur, conn, schema='Agricultural')
ResponseObj = SPTable('response_obj', cur, conn)
ResponseFio = SPTableArbitrary('response_fio' + year, cur, conn, schema='Agricultural')
EventsResponseObj = SPTableManyToMany('events_response_obj' + year, cur, conn, schema='Agricultural')
EventsResponseFio = SPTableManyToMany('events_response_fio' + year, cur, conn, schema='Agricultural')
