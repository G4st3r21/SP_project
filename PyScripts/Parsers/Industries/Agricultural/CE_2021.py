...
cols, rows, cur, conn = parser_init('_11.1. Контрольные события.xlsx', sheet_number=1, first_str_number=199)
ResponseObj = SPTable('response_obj', cur, conn)
ControlEvent2020 = SPTableArbitrary('control_event2021', cur, conn, schema='Agricultural')
CommentsCE2020 = SPTableArbitrary('comments_ce2021',  cur, conn, schema='Agricultural')
DateControlEvent2020 = SPTableArbitrary('date_control_event2021', cur, conn, schema='Agricultural')
table_parsing()
