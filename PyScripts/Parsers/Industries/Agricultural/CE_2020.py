...
ControlEvent2020 = SPTableArbitrary('control_event2020', cur, conn, schema='Agricultural')
CommentsCE2020 = SPTableArbitrary('comments_ce2020',  cur, conn, schema='Agricultural')
DateControlEvent2020 = SPTableArbitrary('date_control_event2020', cur, conn, schema='Agricultural')
table_parsing()
