...
ControlEvent2020 = SPTableArbitrary('control_event2021', cur, conn, schema='Information_Society')
CommentsCE2020 = SPTableArbitrary('comments_ce2021',  cur, conn, schema='Information_Society')
DateControlEvent2020 = SPTableArbitrary('date_control_event2021', cur, conn, schema='Information_Society')
table_parsing()
