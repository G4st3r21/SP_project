...
ControlEvent2020 = SPTableArbitrary('control_event2021', cur, conn, schema='Education')
CommentsCE2020 = SPTableArbitrary('comments_ce2021',  cur, conn, schema='Education')
DateControlEvent2020 = SPTableArbitrary('date_control_event2021', cur, conn, schema='Education')
table_parsing()
