...
ControlEvent2020 = SPTableArbitrary('control_event2021', cur, conn, schema='Public_Order')
CommentsCE2020 = SPTableArbitrary('comments_ce2021',  cur, conn, schema='Public_Order')
DateControlEvent2020 = SPTableArbitrary('date_control_event2021', cur, conn, schema='Public_Order')
table_parsing()
