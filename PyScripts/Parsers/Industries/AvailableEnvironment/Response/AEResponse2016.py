...
Subprogram = SPTableArbitrary('subprogram2016', cur, conn, schema='Available_Environment')
MainEvent = SPTableArbitrary('main_event2016', cur, conn, schema='Available_Environment')
...
ResponseFio = SPTableArbitrary('response_fio2016', cur, conn, schema='Available_Environment')
