...
cols, rows, cur, conn = parser_init("Защита населения_2019.xlsx", sheet_number=1, first_str_number=9)
first_column = 2
first_column -= 1

Gosprogram = Gosprogram(cur, conn)
Subprogram = SPTableArbitrary('subprogram2019', 'title_subprog', cur, conn, schema='Protection_Population')
MainEvent = SPTableArbitrary('main_event2019', 'main_event', cur, conn, schema='Protection_Population')
AllEvents = SPTableManyToMany('all_events2019', cur, conn, schema='Protection_Population')
ResponseObj = SPTable('response_obj', 'response_obj', cur, conn)
ResponseFio = SPTableArbitrary('response_fio2019', 'fio', cur, conn, schema='Protection_Population')
EventsResponseFio = SPTableManyToMany('events_response_fio2019', cur, conn, schema='Protection_Population')
EventsResponseObj = SPTableManyToMany('events_response_obj2019', cur, conn, schema='Protection_Population')
