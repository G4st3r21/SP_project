...
Subprogram = SPTableArbitrary('subprogram' + year, cur, conn, schema='Industrial')
MainEvent = SPTableArbitrary('main_event' + year, cur, conn, schema='Industrial')
Event = SPTableArbitrary('event' + year, cur, conn, schema='Industrial')
AllEvents = SPTableManyToMany('all_events' + year, cur, conn, schema='Industrial')
ResponseObj = SPTable('response_obj', cur, conn)
ResponseFio = SPTableArbitrary('response_fio' + year, cur, conn, schema='Industrial')
EventsResponseObj = SPTableManyToMany('events_response_obj' + year, cur, conn, schema='Industrial')
EventsResponseFio = SPTableManyToMany('events_response_fio' + year, cur, conn, schema='Industrial')
# ResponseMain = SPTableArbitrary('response_main' + year, cur, conn, schema='Industrial')


first_column -= 1
table_parsing()

# Industrial.response_main2016