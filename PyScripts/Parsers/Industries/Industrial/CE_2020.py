...
cols, rows, cur, conn = parser_init('Развитие промышленности_2020.xlsx', sheet_number=1, first_str_number=12)
ResponseObj = SPTable('response_obj', cur, conn)
ControlEvent2020 = SPTableArbitrary('control_event2020', cur, conn, schema='Industrial')
CommentsCE2020 = SPTableArbitrary('comments_ce2020',  cur, conn, schema='Industrial')
DateControlEvent2020 = SPTableArbitrary('date_control_event2020', cur, conn, schema='Industrial')
table_parsing()
