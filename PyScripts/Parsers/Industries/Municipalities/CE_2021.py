...
cols, rows, cur, conn = parser_init('Содействие развитию МО_2021.xlsx', sheet_number=7, first_str_number=12)
ResponseObj = SPTable('response_obj', cur, conn)
ControlEvent2020 = SPTableArbitrary('control_event2021', cur, conn, schema='Municipalities')
CommentsCE2020 = SPTableArbitrary('comments_ce2021',  cur, conn, schema='Municipalities')
DateControlEvent2020 = SPTableArbitrary('date_control_event2021', cur, conn, schema='Municipalities')
table_parsing()
