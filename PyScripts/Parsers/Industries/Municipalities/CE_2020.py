...
ControlEvent2020 = SPTableArbitrary('control_event2020', cur, conn, schema='Municipalities')
CommentsCE2020 = SPTableArbitrary('comments_ce2020',  cur, conn, schema='Municipalities')
DateControlEvent2020 = SPTableArbitrary('date_control_event2020', cur, conn, schema='Municipalities')
table_parsing()
