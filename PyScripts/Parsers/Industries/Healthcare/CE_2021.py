...
ControlEvent2020 = SPTableArbitrary('control_event2021', cur, conn, schema='Healthcare')
CommentsCE2020 = SPTableArbitrary('comments_ce2021',  cur, conn, schema='Healthcare')
DateControlEvent2020 = SPTableArbitrary('date_control_event2021', cur, conn, schema='Healthcare')
table_parsing()
