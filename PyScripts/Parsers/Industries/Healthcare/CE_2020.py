...
cols, rows, cur, conn = parser_init('Отчет за 2020 год.xlsx', sheet_number=5, first_str_number=186)
ResponseObj = SPTable('response_obj', cur, conn)
ControlEvent2020 = SPTableArbitrary('control_event2020', cur, conn, schema='Healthcare')
CommentsCE2020 = SPTableArbitrary('comments_ce2020',  cur, conn, schema='Healthcare')
DateControlEvent2020 = SPTableArbitrary('date_control_event2020', cur, conn, schema='Healthcare')
table_parsing()