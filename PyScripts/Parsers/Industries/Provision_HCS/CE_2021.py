...
ControlEvent2020 = SPTableArbitrary('control_event2021', cur, conn, schema='Provision_HCS')
CommentsCE2020 = SPTableArbitrary('comments_ce2021',  cur, conn, schema='Provision_HCS')
DateControlEvent2020 = SPTableArbitrary('date_control_event2021', cur, conn, schema='Provision_HCS')
table_parsing()
