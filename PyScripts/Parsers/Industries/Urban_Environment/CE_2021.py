...
cols, rows, cur, conn = parser_init('Формирование городской среды_2021.xlsx', sheet_number=5, first_str_number=12)
ResponseObj = SPTable('response_obj', cur, conn)
ControlEvent2020 = SPTableArbitrary('control_event2021', cur, conn, schema='Urban_Environment')
CommentsCE2020 = SPTableArbitrary('comments_ce2021',  cur, conn, schema='Urban_Environment')
DateControlEvent2020 = SPTableArbitrary('date_control_event2021', cur, conn, schema='Urban_Environment')
table_parsing()
