...
ControlEvent2020 = SPTableArbitrary('control_event2020', cur, conn, schema='Urban_Environment')
CommentsCE2020 = SPTableArbitrary('comments_ce2020',  cur, conn, schema='Urban_Environment')
DateControlEvent2020 = SPTableArbitrary('date_control_event2020', cur, conn, schema='Urban_Environment')
table_parsing()
