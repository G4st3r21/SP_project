...
cols, rows, cur, conn = parser_init('отчет.xlsx', sheet_number=5, first_str_number=12)
ResponseObj = SPTable('response_obj', cur, conn)
ControlEvent2020 = SPTableArbitrary('control_event2021', cur, conn, schema='Housing_Provision')
CommentsCE2020 = SPTableArbitrary('comments_ce2021',  cur, conn, schema='Housing_Provision')
DateControlEvent2020 = SPTableArbitrary('date_control_event2021', cur, conn, schema='Housing_Provision')
table_parsing()
