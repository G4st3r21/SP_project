...
Subprogram = SPTableArbitrary('subprogram' + year, cur, conn, schema='Social_Support')
MainEvent = SPTableArbitrary('main_event' + year, cur, conn, schema='Social_Support')
Event = SPTableArbitrary('event' + year, cur, conn, schema='Social_Support')
AllEvents = SPTableManyToMany('all_events' + year, cur, conn, schema='Social_Support')
ResponseObj = SPTable('response_obj', cur, conn)
ResponseFio = SPTableArbitrary('response_fio' + year, cur, conn, schema='Social_Support')
EventsResponseObj = SPTableManyToMany('events_response_obj' + year, cur, conn, schema='Social_Support')
EventsResponseFio = SPTableManyToMany('events_response_fio' + year, cur, conn, schema='Social_Support')
# ResponseMain = SPTableArbitrary('response_main' + year, cur, conn, schema='Social_Support')
