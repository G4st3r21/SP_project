...
cols, rows, cur, conn = parser_init('11.1. Контрольные события_1.xlsx', sheet_number=1, first_str_number=12)
ResponseObj = SPTable('response_obj', cur, conn)
ControlEvent2020 = SPTableArbitrary('control_event2020', cur, conn, schema='Energy_Efficiency')
CommentsCE2020 = SPTableArbitrary('comments_ce2020',  cur, conn, schema='Energy_Efficiency')
DateControlEvent2020 = SPTableArbitrary('date_control_event2020', cur, conn, schema='Energy_Efficiency')
table_parsing()
