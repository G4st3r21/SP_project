...
ControlEvent2020 = SPTableArbitrary('control_event2021', cur, conn, schema='Energy_Efficiency')
CommentsCE2020 = SPTableArbitrary('comments_ce2021',  cur, conn, schema='Energy_Efficiency')
DateControlEvent2020 = SPTableArbitrary('date_control_event2021', cur, conn, schema='Energy_Efficiency')
table_parsing()
