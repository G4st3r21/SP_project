...
ControlEvent2020 = SPTableArbitrary('control_event2021', cur, conn, schema='State_Property')
CommentsCE2020 = SPTableArbitrary('comments_ce2021',  cur, conn, schema='State_Property')
DateControlEvent2020 = SPTableArbitrary('date_control_event2021', cur, conn, schema='State_Property')
table_parsing()
