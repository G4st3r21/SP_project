...
EventsResponseObj = SPTableArbitrary('events_response_obj2016', cur, conn, schema='Education')
EventsResponseFio = SPTableArbitrary('events_response_fio2016', cur, conn, schema='Education')
